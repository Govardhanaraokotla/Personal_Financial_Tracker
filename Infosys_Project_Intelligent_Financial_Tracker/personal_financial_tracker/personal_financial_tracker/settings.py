...
SECRET_KEY = 'django-insecure-08$eyhf6m$zl!3w5*%%+x$^*37&gw33lj!foxf$lfiqq7c6i&('
...
ROOT_URLCONF = 'personal_financial_tracker.urls'
...
WSGI_APPLICATION = 'personal_financial_tracker.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Ram12ya@',  # Replace with your MySQL password
